...
function displayCourses(list) {
  ...
  list.forEach(course => {
    ...
    // Create course card with basic info
    card.innerHTML = `
      ...
      <div class="course-details" style="display: none;">
        ...
        <p class="technology"><strong>Technologies:</strong> ${course.technology.join(', ')}</p>
        <p class="status"><strong>Status:</strong> ${course.completed ? 'Completed' : 'In Progress'}</p>
      </div>
    `;
